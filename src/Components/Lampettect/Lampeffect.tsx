  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-12 bg-gradient-to-br from-slate-700 to-slate-800 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight  text-transparent md:text-7xl"
      >
